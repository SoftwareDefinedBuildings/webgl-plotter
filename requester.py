...
class HTTPRequestHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if self.query:
            ...
            kwargs['hole'] = 'fake-data2' in self.query or 'fake-data2' in self.path
    ...
    def do_POST(self):
        ...
        self.end_headers()
        print self.query
        if self.query.startswith("SENDPOST") or self.query.startswith("select"):
            ...
            if local or url is None:
                ...
                elif newquery == 'select * where Metadata/SourceName = "Fake Data" and Path = "/tests/Data Range Test 2"' or newquery == 'select * where uuid = "fake-data2"':
